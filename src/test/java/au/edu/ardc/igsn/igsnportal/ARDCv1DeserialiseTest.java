...
public class ARDCv1DeserialiseTest {
    ...
    void deserialise_samplev1() throws IOException {
        ...
        assertThat(resource.registeredObjectType).isEqualTo("http://pid.geoscience.gov.au/def/voc/ga/igsncode/PhysicalSample");
        ...
        assertThat(resource.curationDetails.get(0).curator.curatorIdentifier.get(0).curatorIdentifierType).isEqualTo("http://pid.geoscience.gov.au/def/voc/ga/igsncode/DOI");

        // contributors
        assertThat(resource.contributors).hasSize(2);
        assertThat(resource.contributors.get(0).contributorType).isEqualTo("http://registry.it.csiro.au/def/isotc211/CI_RoleCode/pointOfContact");
        ...
        assertThat(resource.contributors.get(1).contributorIdentifier.get(0).contributorIdentifierType).isEqualTo("http://pid.geoscience.gov.au/def/voc/ga/igsncode/ORCID");
        ...
        assertThat(relatedResource.relationType).isEqualTo("http://pid.geoscience.gov.au/def/voc/ga/igsncode/HasReferenceResource");
...
//        assertThat(relatedResource.relatedResourceIdentifier.get(0).value).isEqualTo("eissn-sdoiuowre");
        assertThat(relatedResource.relatedResourceIdentifier.get(0).relatedResourceIdentifierType).isEqualTo("http://pid.geoscience.gov.au/def/voc/ga/igsncode/EISSN");
